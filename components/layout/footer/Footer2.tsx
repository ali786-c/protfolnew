					...
					<div className="container position-relative z-1 border-top border-1 pb-2 pt-4">
						<div className="text-center">
							<a className="d-flex main-logo align-items-center justify-content-center mb-3">
								...
								<span className="fs-4 ms-2">aliyan.dev</span>
							</a>
							<div className="d-flex justify-content-center gap-3">
								<a href="https://linkedin.com/in/muhammad-aliyan-dev" target="_blank" rel="noopener noreferrer">
									<i className="ri-linkedin-fill fs-18" />
								</a>
								<a href="https://github.com/ali786-c" target="_blank" rel="noopener noreferrer">
