									...
									<div className="row g-4">
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Native Android Apps</h6>
												<p className="fs-7 text-300 fw-regular">Building high-performance, native Android applications using <span className="text-secondary-2">Kotlin</span>, <span className="text-secondary-2">Android SDK</span>, and modern design architectures like MVVM.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Local Database Integration</h6>
												<p className="fs-7 text-300 fw-regular">Implementing secure and efficient offline data persistence using <span className="text-secondary-2">Room Database</span> and local SQLite storage.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">API &amp; Network Integration</h6>
												<p className="fs-7 text-300 fw-regular">Integrating external web services and RESTful APIs using libraries like <span className="text-secondary-2">Retrofit</span> and HTTP clients.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Enhancing app responsiveness, memory allocations, and lifecycle handling for a completely <span className="text-secondary-2">bug-free user experience</span>.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Cross-Platform Apps</h6>
												<p className="fs-7 text-300 fw-regular">Developing beautiful, fluid cross-platform mobile apps for Android and iOS using <span className="text-secondary-2">Flutter &amp; Dart</span>.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">AI &amp; Smart Integration</h6>
												<p className="fs-7 text-300 fw-regular">Integrating state-of-the-art AI systems such as <span className="text-secondary-2">Gemini AI</span> to build intelligent mobile apps with predictive capabilities.</p>
											</div>
										</div>
									</div>
