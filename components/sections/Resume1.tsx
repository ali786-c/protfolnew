			...
			<section id="resume" className="section-resume-1 position-relative pt-150 overflow-hidden" data-background="assets/imgs/projects/projects-1/background.png">
					...
					<div className="row mt-6">
									...
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												...
												<p className="text-300 mb-0">University of Sargodha, Pakistan (6th Sem)</p>
											</div>
											<h3 className="text-linear-1 ms-auto fw-semibold">3.6<span className="fs-4 fw-bold">/4.0</span></h3>
										</div>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												<p className="fw-extra-bold text-linear-1 mb-2">2021 - 2023</p>
												<h5>FSc Pre-Engineering</h5>
												<p className="text-300 mb-0">Superior College Sargodha, Pakistan</p>
											</div>
											<h3 className="text-linear-1 ms-auto fw-semibold">911<span className="fs-4 fw-bold"> m</span></h3>
										</div>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												...
												<h5>Matric Computer Science</h5>
												<p className="text-300 mb-0">Govt. High School Sargodha, Pakistan</p>
											</div>
											<h3 className="text-linear-1 ms-auto fw-semibold">1076<span className="fs-4 fw-bold"> m</span></h3>
										</div>
									</div>
								</div>
							</div>
						...
						<div className="col-lg-6 col-12">
							<div className="resume-card p-lg-6 p-4 h-100">
								...
								<div className="resume-card-body">
									<div className="resume-card-item px-4 py-3 mt-5">
										<p className="fw-extra-bold text-linear-1 mb-2">May 2025 - Present</p>
										<h5>Fiverr (Freelance)</h5>
										<p className="text-300 mb-0">Level One Seller with 13+ successful projects and 4.9/5.0 rating.</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<p className="fw-extra-bold text-linear-1 mb-2">June 2025 - Present</p>
										<h5>Professional Development</h5>
										<p className="text-300 mb-0">Hands-on experience in UI design, navigation, data handling, and Android app architecture.</p>
									</div>
								</div>
							</div>
						</div>
				...
				<div className="scroll-move-right position-relative pb-160 pt-lg-150">
					<div className="d-flex align-items-center gap-5 wow img-custom-anim-top position-absolute top-50 start-50 translate-middle">
						<h3 className="stroke fs-150 text-uppercase text-white">Android SDK . MVVM Architecture . Kotlin . Flutter . Retrofit . Room Database</h3>
					</div>
				</div>
			</section>
