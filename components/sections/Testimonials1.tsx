									...
									<div className="swiper-wrapper">
										...
										<SwiperSlide>
											<div className="bg-white card-testimonial-1 p-lg-7 p-md-5 mx-3 mx-md-0 p-4 border-2 rounded-4 position-relative">
												...
												<h6 className="mb-7">“Working with Muhammad Aliyan was an absolute pleasure. His expertise in Android development and attention to app performance significantly improved our product's quality.”</h6>
