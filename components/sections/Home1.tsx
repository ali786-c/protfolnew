				...
				<div className="container position-relative z-3">
					<div className="row">
						<div className="col-lg-6 col-md-12">
							<span className="text-dark">👋 Hi there, I'm Muhammad Aliyan</span>
							<h1 className="ds-2 mb-3">Building Scalable <span className="text-primary-1">Android Applications</span></h1>
							<p className="text-300 mb-6">I am a result-oriented Android Developer and Software Engineer with proven experience in building scalable Android applications, integrating AI engines, and local database management.</p>
							...
							<p className="text-400 mt-6 mb-3">Specialized in Android SDK, MVVM Architecture, and Gemini AI</p>
