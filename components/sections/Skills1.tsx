						...
						<div className="d-flex flex-wrap flex-lg-nowrap justify-content-center gap-3 mb-7 px-6">
							<div className="skills">
								...
								<div className="skills-ratio text-center">
									...
									<p className="text-400 fw-medium text-uppercase">Kotlin</p>
								</div>
							</div>
							<div className="skills">
								<div className="skills-icon mb-5">
								...
								<div className="skills-ratio text-center">
									...
									<p className="text-400 fw-medium text-uppercase">Android SDK</p>
								</div>
							</div>
							<div className="skills">
								<div className="skills-icon mb-5">
								...
								<div className="skills-ratio text-center">
									<h3 className="count fw-semibold my-0"><CountUp className="odometer fw-semibold" enableScrollSpy={true} end={90} />%</h3>
									<p className="text-400 fw-medium text-uppercase">MVVM Arch</p>
								</div>
							</div>
							<div className="skills">
								<div className="skills-icon mb-5">
								...
								<div className="skills-ratio text-center">
									...
									<p className="text-400 fw-medium text-uppercase">Room DB</p>
								</div>
							</div>
							<div className="skills">
								<div className="skills-icon mb-5">
								...
								<div className="skills-ratio text-center">
									<h3 className="count fw-semibold my-0"><CountUp className="odometer fw-semibold" enableScrollSpy={true} end={85} />%</h3>
									<p className="text-400 fw-medium text-uppercase">Retrofit</p>
								</div>
							</div>
							<div className="skills">
								<div className="skills-icon mb-5">
								...
								<div className="skills-ratio text-center">
									...
									<p className="text-400 fw-medium text-uppercase">Flutter</p>
								</div>
							</div>
							<div className="skills">
								<div className="skills-icon mb-5">
								...
								<div className="skills-ratio text-center">
									<h3 className="count fw-semibold my-0"><CountUp className="odometer fw-semibold" enableScrollSpy={true} end={80} />%</h3>
									<p className="text-400 fw-medium text-uppercase">Gemini AI</p>
								</div>
							</div>
						</div>
						<div className="text-center">
							<p className="fs-5 text-200 mb-0">In addition, I have hands-on experience with: </p>
							<div className="d-flex justify-content-center gap-1">
								<Link href="/#" className="fs-5 fw-bold">JSON,</Link>
								<Link href="/#" className="fs-5 fw-bold">Dart,</Link>
								<Link href="/#" className="fs-5 fw-bold">ViewBinding,</Link>
								<Link href="/#" className="fs-5 fw-bold">Navigation Component,</Link>
								<Link href="/#" className="fs-5 fw-bold">Material Design,</Link>
								<Link href="/#" className="fs-5 fw-bold">Git,</Link>
								<Link href="/#" className="fs-5 fw-bold">GitHub,</Link>
								<Link href="/#" className="fs-5 fw-bold">Android Studio</Link>
							</div>
						</div>
					</div>
				</div>
